  ...
  return (
    <>
      ...
      <motion.p
        ...
        className="mb-5 text-[#ffffff] text-justify sm:text-[18px] text-[13px] leading-[30px]"
      >
        In this section, I will present the technologies that I acquired while training and learning skills for dev , as well as those that I learned on my own. <br /> To
