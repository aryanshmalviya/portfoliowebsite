    ...
    >
      <div className="w-full flex justify-center gap-3 justify-around max-w-7xl mx-auto">
        ...
        <div className="flex items-center ml-[-12px]">
          <a
            onClick={() =>
              handleIconClick('github', 'https://github.com/aryanshmalviya')
            }
          >
            <FontAwesomeIcon
              icon={faGithub}
          ...
          <a
            onClick={() =>
              handleIconClick(
                'linkedin',
                'https://www.linkedin.com/in/aryansh-malviya-4445ba1b2/',
              )
            }
          >
            <FontAwesomeIcon
          ...
          <a
            onClick={() =>
              handleIconClick(
                'instagram',
                'https://www.instagram.com/aryansh_malviya/',
              )
            }
          >
            <FontAwesomeIcon
